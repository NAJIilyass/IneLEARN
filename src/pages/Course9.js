        ...
        <div>
            <div className="middleCoursesPage">
                <div className="leftCoursespage" id="leftCoursespage">
                    ...
                    <Link to="/Course9" className="selectedPage">
                        JS Arithmetic
                    </Link>
                ...
                <div className="rightCoursesSide" id="rightCoursesSide">
                    ...
                    <p>
                        ...
                        values Variable values Fixed values are called
                        Literals.ML element (with id="demo"), and changes the e
                        lement content (innerHTML) to "Hello JavaScript":
                    </p>
                    ...
                    <h4>JavaScript Can Change HTML Attribute Values</h4>
                    <p>
