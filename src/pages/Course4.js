        ...
        <div>
            <div className="middleCoursesPage">
                <div className="leftCoursespage" id="leftCoursespage">
                    ...
                    <Link to="/Course4" className="selectedPage">
                        JS Statements
                    </Link>
                ...
                <div className="rightCoursesSide" id="rightCoursesSide">
                    ...
                    <p>
                        ...
                        "executed" by a computer. TIn a programming language,
                        these programming instructions are called statements.and
                        changes the e lement content (innerHTML) to "Hello
                        JavaScript":
                    </p>
