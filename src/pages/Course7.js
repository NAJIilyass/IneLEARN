        ...
        <div>
            <div className="middleCoursesPage">
                <div className="leftCoursespage" id="leftCoursespage">
                    ...
                    <Link to="/Course7" className="selectedPage">
                        JS Let - Const
                    </Link>
                ...
                <div className="rightCoursesSide" id="rightCoursesSide">
                    ...
                    <p>
                        ...
                        lVariable values are called Variables:
                    </p>
                    ...
                    <p>
                        ...
                        data values JavaScript uses the keywords var, let and
                        const to declare variables
                        <br />
                        An equal sign is used to assign values to variables In
                        this example, x is defined as a variable. Then, x is
                    ...
                    <div className="DidYouKnow">
                        ...
                        <p>
                            ...
                            languages, both in concept and design. JavaScript
                            was invented by Brendan Eich in 1995 and became an
                            ECMA standard in 1997. ECMA-262 is the official name
                            of the standard. ECMAScript is the official name of
                            the language.
                        </p>
                    </div>
