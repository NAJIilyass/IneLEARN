    ...
    return (
        <div style={{ backgroundColor: "#EDEDED" }}>
            ...
            <div class="trust">
                <h1>
                    Trusted by over{" "}
                    <span style={{ color: "#FF4B4B" }}>10,000</span> Companies{" "}
                </h1>
            </div>
            <br />
            <br />
                ...
                <div class="CoursesContainer">
                    <a href="/GameDev">
                        <div class="course" style={{ marginTop: "1rem" }}>
                            ...
                            <p>
                                Dorsal est un terme désignant un étage de sortie
                                d'un logiciel devant produire un résultat.
                            </p>
                    ...
                    <a href="/GameDev">
                        <div class="course" style={{ marginTop: "1rem" }}>
                            ...
                            <h2>Mobile Apps</h2>
                            <p>
                                Le dév mobile est le processus de création
                                d'applications logicielles spécifiquement
                                conçues
                            </p>
                            <div class="buttomCourse">
                                <div
                    ...
                    <a href="/GameDev">
                        <div class="course" style={{ marginTop: "1rem" }}>
                            ...
                            <p>
                                Le Machine Learning est quelque chose de nouveau
                                sous le soleil : une technologie qui se
                                construit elle-même.
                            </p>
                            <div class="buttomCourse">
                                <div
                    ...
                    <a href="/GameDev">
                        <div class="course" style={{ marginTop: "3rem" }}>
                            ...
                            <p>
                                Le développement de jeux nécessite une
                                combinaison unique de créativité, de compétences
                                techniques et d'attention aux détails
                            </p>
                            <div class="buttomCourse">
                                <div
                                    style={{
                    ...
                    <a href="/GameDev">
                        <div class="course" style={{ marginTop: "3rem" }}>
                            ...
                            <p>
                                ...
                                multidisciplinaire qui combine des techniques
                                d'analyse statistique, d'apprentissage
                                automatique .
                            </p>
                            <div class="buttomCourse">
                                <div
                    ...
                    <a href="/GameDev">
                        <div class="course" style={{ marginTop: "3rem" }}>
                            ...
                            <p style={{ fontSize: "15px" }}>
                                Le développement Web implique la conception, le
                                codage et la maintenance de sites Web et
                                d'applications Web, à l'aide d'une variété de
                                langages .
                            </p>
                            <div class="buttomCourse">
                                <div
            ...
            <div className="numberCourses">
                <div style={{ backgroundColor: "transparent" }}>
                    <p style={{ backgroundColor: "transparent" }}> +20 000</p>
                    <br />
                    <p style={{ backgroundColor: "transparent" }}>Learners</p>
                </div>
                <div style={{ backgroundColor: "transparent" }}>
                    <p style={{ backgroundColor: "transparent" }}> +200</p>
                    <br />
                    <p style={{ backgroundColor: "transparent" }}>Courses</p>
                </div>
                <div style={{ backgroundColor: "transparent" }}>
                    <p style={{ backgroundColor: "transparent" }}> +100</p>
                    <br />
                ...
                <div className="leftSideClasse">
                    <h2>
                        ...
                        <span style={{ color: "#00CBB8" }}>
                            you can do it with IneRread
                        </span>{" "}
                    </h2>{" "}
                    <br />
                    <p>
                        Lorem Ipsum est simplement du faux texte employé dans la
                        composition et la mise en page avant impression. Le
            ...
            <div className="Testimonials">
                ...
                <div class="containerTestimonials">
                    <div class="leftSideTestimonials">
                        <p
                            class="whatTheysay"
                            style={{ color: "#2F327D", fontSize: "40px" }}
                        >
                            What they say
                        </p>
                        <p style={{ width: "60%" }}>
                            IneLearn has got more than 100k positive ratings
                            from our users around the world.{" "}
                        </p>
                        <br />
                        <p>Many of the student were greatly helped</p>
                        <br />
            ...
            <div class="Footer">
                ...
                <div class="infosFooter">
                    <div class="aboutUsInfos">
                        <h1>ABOUT US</h1>
                        <p>
                            Lorem Ipsum est simplement du faux texte employé
                            dans la composition et la mise en page Ipsum est
                            simplement du faux texte employé dans la composition
                            et la mise.Lorem Ipsum est simplement du faux texte
                            employé dans la composition composition et la mise.
                            et la mise en page Ipsum est simplement du faux
                            texte employé dans la Lorem{" "}
                        </p>
                    </div>
                    <div class="aboutUsInfos">
                        <h1>COURSES</h1>
