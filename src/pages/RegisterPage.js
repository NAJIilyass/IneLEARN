...
function RegisterPage() {
    useEffect(() => {
        ...
        const passwordInputRegister = document.getElementById(
            "passwordInputRegister"
        );
        const emailInputregister =
            document.getElementById("emailInputregister");
                ...
                <div class="loginBody">
                    ...
                    <div class="rightBodyLogin">
                        <div class="headRightBody">
                            ...
                            <p
                                style={{
                                    backgroundColor: "rgba(73 , 187, 189, 0.6)",
                                    width: "33%",
                                    textAlign: "center",
                                    height: "30px",
                                    alignItems: "center",
                        ...
                        <p>
                            Welcome again, please enter the informations to
                            login :
                        </p>
                        <h4>Email</h4>
                        <input
                        ...
                        <a href="/">
                            <button id="submitButtonRegister">REGISTER</button>
                        </a>
                    </div>
                </div>
            </section>
